...
router.get('/slack/connect', (req, res) => {
    const authURL = `https://slack.com/oauth/v2/authorize?client_id={&scope=channels:read,groups:read,im:read,mpim:read&redirect_uri=https://3937c4c33d57.ngrok-free.app/slack/callback
`;
